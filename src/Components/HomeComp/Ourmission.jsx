...
export default function Ourmission() {
  return (
    <div className='w-full h-[110vh] bg-white flex flex-col items-center justify-center'>
        <h1 className='font-bold text-black text-4xl pb-18 font-serif pt-14'>What Makes Our Teaching Unique</h1>
        <div className='container w-full h-[540px] flex flex-col items-center justify-between'>
            <div className='w-[76%] h-[260px] rounded-4xl bg-cyan-400 relative left-30'>
            <div className="text w-[80%] h-[80%]  flex flex-col justify-between p-4 ">
                <h1 className="text-4xl font-serif text-white px-7">Our Mission</h1>
                <h1 className="text-[20px]  text-white font-sans px-7 ">We aim to revolutionise the educational landscape by providing a top-tier individually-tailored online learning environment where learners can thrive academically and professionally.
        ...
        <div className='w-[76%] h-[260px] rounded-4xl bg-cyan-400 relative right-30 flex flex-row'>
            ...
            <div className="text w-[90%] h-[96%]  flex flex-col justify-between p-4">
                <h1 className="text-4xl font-serif text-white px-7 pb-4 ">Our Vission</h1>
                <h1 className="text-[20px]  text-white px-7 ">
