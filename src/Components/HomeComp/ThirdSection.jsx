...
export default function ThirdSection() {
  ...
  return (
    <div>
         <div className="w-full h-[106vh] flex gap-10 pt-10 px-10 flex-col items-center overflow-hidden">
           <h1 className="text-4xl text-yellow-950/90 font-serif font-bold">Our Team</h1>
           <div className="contetnt-carousel  h-[74vh] flex items-center rounded-4xl p-4 w-full">
               ...
               <motion.div drag="x" dragConstraints={{right: 0 , left: -width }} className="inner-carousel flex w-max gap-6">
                 {Teams.map((Teams)=>(
               <motion.div className="item h-[470px] flex flex-row  bg-yellow-950/90 w-[27rem] py-[40px] px-[20px] justify-center rounded-tr-4xl rounded-bl-4xl " key={Teams}>
                  <div className="teacher-details  w-full h-full flex flex-col justify-center">
                    ...
                    <div className="teacher-details-text  w-full">
                      <h1 className="text-orange-100 px-3 py-2 font-serif text-2xl">Miss Mirna</h1>
                      <h1 className="text-orange-100 px-3  text-2xl">Science Teacher</h1>
